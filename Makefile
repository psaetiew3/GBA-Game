...
OFILES = main.o mylib.o Player.o GreenPig.o RedBird.o YellowBird.o BlueBird.o title.o background.o gameover.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = DMA.h Player.h GreenPig.h RedBird.h YellowBird.h BlueBird.h title.h background.h gameover.h mylib.h
